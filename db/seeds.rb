...
Now we must turn to the horrors of nature. I am afraid this is inevitable. Nature is not something to be coddled and accepted and held to your bosom like a wounded snake. Tell me, what was there before you were born? What do you remember? That is nature. Nature is a void. An emptiness. A vacuum. And speaking of vacuum, I am not sure you're using the retractable nozzle correctly or applying the 'full weft' setting when attending to the lush carpets of the den. I found some dander there.", prompt_id: 1,  user_id: 1, viewer_id: 2, is_private: false, is_read: false, can_respond: false, stream:false)
...
Entry.create(body: " I kind of feel like a dork writing about myself like this as if I were an American pop-rock icon-demi God, or a self-confessed product of corporate-packaged rebellion, but I've heard so many insanely exhaggerated stories or reports from my friends and Ive read so many pathetic second rate,
 ...
 parks. Saturdays: puppet show, rollercoaster & Nirvana ...", prompt_id: 1,  user_id: 1, viewer_id: 2, is_private: false, is_read: false, can_respond: false, stream:false)
Entry.create(body: "Dearest, I feel certain I am going mad again. I feel we can’t go through another of those terrible times. And I shan’t recover this time. I begin to hear voices, and I can’t concentrate. So I am doing what seems the best thing to do. You have given me the greatest possible happiness. You have been in every way all that anyone could be. I don’t think two people could have been happier till this terrible disease came. I can’t fight any longer. I know that I am spoiling your life, that without me you could work. And you will I know. You see I can’t even write this properly. I can’t read. What I want to say is I owe all the happiness of my life to you. You have been entirely patient with me and incredibly good. I want to say that – everybody knows it. If anybody could have saved me it would have been you. Everything has gone from me but the certainty of your goodness. I can’t go on spoiling your life any longer. I don’t think two people could have been happier than we have been.", prompt_id: 1,  user_id: 1, viewer_id: 2, is_private: false, is_read: false, can_respond: false, stream:false)
...
Entry.create(body: "walking to wal-mart", prompt_id: 1,  user_id: 1, viewer_id: 2, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "I'm also at wal-mart", prompt_id: 1,  user_id: 1, viewer_id: 2, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "this wal-mart smells weird", prompt_id: 1,  user_id: 1, viewer_id: 2, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "Home Depot FTW", user_id: 1, prompt_id: 1,  viewer_id: 2, stream: true)
Entry.create(body: "I am what I am and no more, well, maybe",user_id: 1, prompt_id: 2,  viewer_id: 2, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "If Wal-Mart doesn't have the DVDs I desire I will not be okay.", prompt_id: 1,  user_id: 1, viewer_id: 2, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "All right, leaving Wal-Mart", user_id: 1, prompt_id: 1,  viewer_id: 2, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "Lowes FTW!", user_id: 1,  prompt_id: 1, viewer_id: 2, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "Wal-Mart Is Now Closing", prompt_id: 1,  user_id: 1, viewer_id: 2, is_private: false, is_read: false, can_respond: false,  stream: true)
