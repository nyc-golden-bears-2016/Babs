...
User.create(username: "Ben", email: "bbehrman10@gmail.com", password: "123456")
...
Entry.create(body: "walking to wal-mart", prompt_id: 1,  user_id: 1, viewer_id: 1, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "I'm also at wal-mart", prompt_id: 1,  user_id: 1, viewer_id: 1, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "this wal-mart smells weird", prompt_id: 1,  user_id: 1, viewer_id: 1, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "Home Depot FTW", user_id: 1, prompt_id: 1,  viewer_id: 1, stream: true)
Entry.create(body: "I am what I am and no more, well, maybe",user_id: 1, prompt_id: 1,  viewer_id: 1, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "If Wal-Mart doesn't have the DVDs I desire I will not be okay.", prompt_id: 1,  user_id: 1, viewer_id: 1, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "All right, leaving Wal-Mart", user_id: 1, prompt_id: 1,  viewer_id: 1, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "Lowes FTW!", user_id: 1,  prompt_id: 1, viewer_id: 1, is_private: false, is_read: false, can_respond: false,  stream: true)
Entry.create(body: "Wal-Mart Is Now Closing", prompt_id: 1,  user_id: 1, viewer_id: 1, is_private: false, is_read: false, can_respond: false,  stream: true)
